---
title: "1.Insular tutorial Intro"
format: html
editor: visual
author: Luis Valente
---
...
1.  [Learn how to use `DAISIEprep`](#sec-1.-daisieprep) to prepare and extract data.

2.  [Learn how to use `DAISIE`](#sec-2.-daisie) to estimate parameters and simulate islands.

3.  Apply the above approaches to a dataset of frogs from the Caribbean. Writing up this part is the **graded** **assignment**.
...
## 1. [`DAISIEprep`](https://github.com/joshwlambert/LearnDAISIEprep/blob/main/2.DAISIEprep.qmd) {#sec-1.-daisieprep}

## 2. [`DAISIE`](https://github.com/joshwlambert/LearnDAISIEprep/blob/main/3.DAISIE_Galapagos.qmd) {#sec-2.-daisie}

## Load the *Insula* data required
