...
3.  Apply the above approaches to a dataset of frogs from the Caribbean. Writing up this part is the [**graded** **assignment**](#sec-3.-applying-daisie).
...
## 3. Applying `DAISIE` to Caribbean frog dataset {#sec-3.-applying-daisie}
...
![Phylogeny showing the geographical distribution of the extant species](0.Insula_frog_data/Figure_Insula_tip_states.png)

-   `Figure_Insula_ancestral_state_reconstruction.pdf:` A figure of an ancestral range reconstruction for the genus.

![Ancestral area reconstruction](0.Insula_frog_data/Figure_Insula_ancestral_state_reconstruction.png){width="534"}
