...
3.  [Apply the above approaches to a dataset of frogs from the Caribbean](#sec-insula). Writing up this part is the graded assignment.
...
-   [Rstudio](https://rstudio.com/products/rstudio/download/) with packages

-   Open the program RStudio. Open the file "DAISIE_setup.R" and run that code in Rstudio. This should install all required R packages (**may take a while!**).
...
[DAISIEprep tutorial quarto](https://github.com/joshwlambert/LearnDAISIEprep/blob/main/2.DAISIEprep.qmd) 

[DAISIEprep tutorial HTML](https://github.com/joshwlambert/LearnDAISIEprep/blob/main/2.DAISIEprep.html) 

## 2. DAISIE {#sec-2.-daisie}

[DAISIE tutorial quarto](https://github.com/joshwlambert/LearnDAISIEprep/blob/main/3.DAISIE.qmd) 

[DAISIE tutorial HTML](https://github.com/joshwlambert/LearnDAISIEprep/blob/main/3.DAISIE.html) 

#### After you have finished the DAISIEprep and DAISIE practicals, you can begin with the applying these techniques to the *Insula* dataset.
