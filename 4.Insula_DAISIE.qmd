---
title: "4.Insula_DAISIE"
format: html
editor: visual
author: Luis Valente
---

## Example of how to extract data for Hispaniola species from the *Insula* tree, add missing species, fit DAISIE models and run simulations.
...
Look in the [checklist](data/Insula_checklist.xlsx) to see which species occur on Hispaniola. Specify tips corresponding to Hispaniola species by specifying that they are endemic and/or non-endemic to the island:
...
It looks like *Insula* diversity in the island of Hispaniola is at a dynamic equilibrium.
