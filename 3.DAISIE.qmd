...
## Part 3 - Fitting DAISIE models using the Galápagos birds as example
...
### 3.1 - Load and visualise Galapágos bird data
...
\
The end of the DAISIE practical. Well done! Now you are ready to work on the [*Insula* assignment](1.Insula_tutorial_Intro.html#sec-insula).
